...
export function registerLOCTools(server) {
    server.registerTool("get_user_loc", {
        title: "Get User Lines of Code",
        description: "Get lines of code (additions/deletions) for a specific user across organization repositories",
